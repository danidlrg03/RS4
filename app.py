...
# --------------------------------------------------
# html layout of the application, specified in layout (from App.layout)
app.layout = layout
...
#callback for updating plots that are shown below the table, also handles what happens when one or more rows are selected
